...
需求见 `documents/PRD.md`,当前阶段计划见 `documents/S0-PLAN.md`,表结构唯一出处 `documents/DB-DESIGN.md`,前端风格唯一出处 `documents/UI-STYLE.md`。开发文档与代码注释用中文;**前端界面文案、Agent 问答交互、演示知识内容一律英文**(平台使用对象是澳洲用户,无 i18n,英文单语)。
